...
console.log('✓ Rejected 0-point and 1-point invalid tracks');
...
console.log('✓ Discarded out-of-range and NaN coordinates');
...
console.log('✓ Filtered non-finite and extreme elevation spikes');
...
console.log('✓ Successfully detected and purged >50km GPS coordinate telemetry spike');
...
console.log('✓ Non-monotonic timestamps flagged and sanitized');
